...
import { ListForm, usePurchaseLogics } from "./logics";
...
export default function PurchaseForm({
  ...
  const isEditForm = type === "edit-form";

  if (type != "add-form" && !row) throw new Error("Row belum ada");
      ...
      >
        ...
        <div className="flex gap-2 items-center">
          ...
          >
            {isLoading
              ? "Menyimpan"
              : `${isEditForm ? "Edit" : "Simpan"} Pembelian`}
          </Button>
          <Button
            className="cursor-pointer"
            type="button"
